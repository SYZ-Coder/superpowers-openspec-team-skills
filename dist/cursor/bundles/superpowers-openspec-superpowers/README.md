...
Copy this bundle into the target repository root when you want the workflow that says: think it through first, lock it down second, then come back and build it right.
