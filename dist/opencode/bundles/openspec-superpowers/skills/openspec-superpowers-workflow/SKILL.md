...
description: Standalone OpenCode workflow for OpenSpec-first artifacts, then Superpowers implementation planning, TDD, and verification, including follow-up turns that confirm or revise generated tasks.
---
...
This is an explicit opt-in workflow. Do not use it by default. Only use it when the user explicitly asks for it, names `openspec-superpowers-workflow` or `$openspec-superpowers-workflow`, or a repository policy explicitly requires it.
