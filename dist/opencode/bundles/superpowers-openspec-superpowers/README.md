# OpenCode Bundle: Superpowers -> OpenSpec -> Superpowers

Install this bundle when you want a steadier path through complex feature work:
...
```text
Use the superpowers-openspec-superpowers-workflow skill to run this feature from exploration through archive.
```
