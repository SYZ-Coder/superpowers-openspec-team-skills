...
$bundleRoot = Join-Path $repoRoot "dist\cursor\bundles\$bundleFolder"
$backupRoot = Join-Path $ProjectRoot ".ai-skill-backups\cursor"
...
Write-Host "Cursor bundle: $Bundle"
...
Write-Host ""
Write-Host "Installed Cursor bundle '$Bundle' into $ProjectRoot"
Write-Host "Next: reopen the repository in Cursor and use the bundled rule files."
